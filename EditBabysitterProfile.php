...
<body style=" background-color: #eee">
  ...
  <div class="navbar navbar-expand-lg navbar-light text-light " style="background-color: rgb(227, 217, 175);">
    ...
    <?php $babysitter = $_SESSION['babysitterID']; 
if(isset($_POST['save'])){
                    ...
                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                      ...
                      <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Edit Profile</p>
                        ...
                        <div id="addinPic" class="d-flex flex-column align-self-center mt-4" class="profile">
                          <img  src="<?php if(isset($_POST['profile-img'])) echo 'css/images/'.$_POST['profile-img']; else echo $profilephoto;?>" alt="profile pic" name = "profilePhoto" class = "profile_image" id='here' >
                          <br>
                        ...
                        <div class="form-outline">
                          ...
                          <input type="tel" name = "phone" id="phone" value="<?php echo $PhoneNo;?>" class="form-control">
