...
<body>
  ...
  <div class="navbar navbar-expand-lg navbar-light text-light " style="background-color: rgb(227, 217, 175);">
      ...
      <a class="navbar-brand mb-0 h1" href="babysitterHome.php"><img src="css/images/logo.png" style="width: 35%;" alt="Logo"></a>
          ...
          <div class="collapse navbar-collapse" id="cNav">
            ...
            <ul class="navbar-nav" style="margin-left: -200px;">
              <li class="nav-item"><a href="babysitterHome.php" class="nav-link active">Home</a></li>
    ...
    <div class="hero" id="sitter">
      <div class="hero-text">
        <h1>Hello, Babysitter!</h1>
        ...
        <a class="btn" href="babysitterRequest.php" role="button">View Job Requests</a>
        <a class="btn" href="babysitterOffers.php" role="button">View My Offers</a>
